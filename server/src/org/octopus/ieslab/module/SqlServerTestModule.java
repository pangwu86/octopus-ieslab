...
@At("/ieslab/sqlserver")
@Ok("ajax")
public class SqlServerTestModule extends AbstractBaseModule {
    ...
    public AjaxReturn test() {
        return execSql("select * from TrackProcess_V");
    }

    @At("/libpath")
    public AjaxReturn libpath() {
        String libpath = System.getProperty("java.library.path");
        return Ajax.ok().setData(libpath);
    }
}
